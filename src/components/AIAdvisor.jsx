...
import { Bot, Send, User, ShoppingCart, Loader2 } from 'lucide-react';
import { products } from '../mockData';

export default function AIAdvisor({ onAddToCart }) {
  ...
  return (
    <div className="glass-panel" style={{
      ...
      {/* Header */}
      <div style={{
        background: 'linear-gradient(90deg, rgba(10, 25, 47, 0.95) 0%, rgba(0, 123, 255, 0.2) 100%)',
        padding: '16px 20px',
        ...
        <div>
          <h3 style={{ fontSize: '15px', fontWeight: '800' }}>CỐ VẤN KỸ THUẬT AI</h3>
          <span style={{ fontSize: '11px', color: '#81c784', display: 'flex', alignItems: 'center', gap: '4px' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                <div style={{
                  ...
                  border: isAI ? '1px solid rgba(255,255,255,0.06)' : '1px solid rgba(253,139,0,0.2)',
                  fontSize: '13px',
                  lineHeight: '1.5',
                  color: '#ffffff'
                }}>
                    ...
                    {msg.recommendations.map((prod) => (
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          ...
                          />
                          <div>
                            <span style={{ fontSize: '12px', fontWeight: '600', color: 'white', display: 'block', maxWidth: '240px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                              {prod.name}
                            </span>
